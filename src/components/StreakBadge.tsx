...
export function StreakBadge({ streak, size = 'sm', freezeAvailable = false, onClick }: Props) {
  ...
  const content = (
    <>
      ...
      >
        {size === 'sm' ? (
          /* Simplified flame — no inner cutout; reads cleanly at 16px */
          <path d="M12 23c-4.97 0-8-3.03-8-7.5 0-3.82 2.83-7.2 5.65-9.94a.75.75 0 0 1 1.12.12c.7 1.05 1.48 1.88 2.23 2.38.12-.93.43-2.2 1.15-3.56a.75.75 0 0 1 1.31-.05C17.3 7.8 20 11.58 20 15.5 20 19.97 16.97 23 12 23Z" />
        ) : (
          /* Detailed flame with inner droplet — visible at 20px+ */
