...
export const SEED_EXERCISES: ExerciseSeed[] = [
  // aunque + indicativo
  {
    concept_index: 0,
    type: 'gap_fill',
    prompt: 'Aunque ___ mucho calor ese día, los niños salieron a jugar sin quejarse.',
    expected_answer: 'hacía',
    answer_variants: null,
    hint_1: '"Aunque" + indicative = real concession (the heat is a confirmed fact). Fill in the imperfect of "hacer calor".',
    hint_2: '"Hacer calor" in the imperfect (ongoing past state): hacía. "Hacer" is irregular: yo hacía, tú hacías, él/ella hacía.',
  },
  {
    concept_index: 0,
    type: 'transformation',
  ...
  // aunque + subjuntivo
  {
    ...
    answer_variants: null,
    hint_1: 'Both blanks need the same connector meaning "even if" — it introduces a hypothetical concession (not a confirmed fact).',
  ...
  // a pesar de que
  {
    concept_index: 2,
    type: 'gap_fill',
    prompt: '___ de que hacía mucho frío, los niños jugaron en el parque durante toda la tarde sin quejarse.',
    expected_answer: 'A pesar',
    answer_variants: null,
    hint_1: 'Concessive connector meaning "despite/in spite of" — more formal than "aunque". Structure: ___ de que + confirmed fact.',
    hint_2: 'The full expression is two words: "A pesar". It is followed by "de que" + indicative (confirmed cold) or infinitive.',
  },
  {
    concept_index: 2,
    type: 'transformation',
  ...
  // sin embargo
  {
    concept_index: 3,
    type: 'gap_fill',
    prompt: 'El informe llegó con dos días de retraso; ___, decidimos presentarlo en la reunión sin más cambios.',
    expected_answer: 'sin embargo',
    answer_variants: null,
    hint_1: 'Formal contrast connector that follows a semicolon or full stop, meaning "however/nevertheless". More formal than "pero".',
    hint_2: 'Register check: "no obstante" is also possible here but even more formal. "En cambio" introduces a different perspective rather than overcoming an obstacle.',
  },
  {
    concept_index: 3,
  ...
  // por más que
  {
    concept_index: 4,
    type: 'gap_fill',
    prompt: '___ que lo intento, no consigo pronunciar la "r" española de forma natural.',
    expected_answer: 'Por más',
    answer_variants: ['Por mucho'],
    hint_1: '"No matter how much" + verb = Por ___ que + subjunctive. The blank is two words.',
    hint_2: '"Por más que" and "por mucho que" are interchangeable. Both express an effort that produces no result.',
  },
  {
    concept_index: 4,
    type: 'translation',
  ...
  // puesto que / ya que
  {
    concept_index: 5,
    type: 'gap_fill',
    prompt: '___ no tienes hambre ahora, podemos cenar más tarde sin ningún problema.',
    expected_answer: 'Ya que',
    answer_variants: ['Puesto que'],
    hint_1: 'Formal causal connector meaning "since/given that". Unlike "porque", it presents the cause as already known to both speakers.',
    hint_2: '"Ya que" and "puesto que" are interchangeable. "Dado que" is similar but more restricted to written, very formal contexts.',
  },
  {
    concept_index: 5,
    type: 'transformation',
  ...
  // dado que
  {
    concept_index: 6,
    type: 'gap_fill',
    prompt: '___ el tiempo es limitado, les pido que guarden sus preguntas para el final de la presentación.',
    expected_answer: 'Dado que',
    answer_variants: null,
    hint_1: 'Formal written causal connector meaning "given that". Register: more formal than "ya que"; common in reports and academic writing.',
    hint_2: '"Dado que" presents the reason as an obvious, shared fact. Compare: "ya que" (spoken/formal) vs. "dado que" (written/very formal).',
  },
  {
    concept_index: 6,
    type: 'free_write',
  ...
  // por lo tanto
  {
    concept_index: 7,
    type: 'gap_fill',
    prompt: 'No estudió para el examen; ___, suspendió todas las asignaturas.',
    expected_answer: 'por lo tanto',
    answer_variants: ['por consiguiente'],
    hint_1: 'Consecutive connector meaning "therefore/consequently". Introduces the logical result of the preceding statement.',
    hint_2: '"Por lo tanto" and "por consiguiente" are synonymous. Both follow a semicolon or full stop, never a comma alone.',
  },
  {
    concept_index: 7,
  ...
  // de ahí que
  {
    concept_index: 8,
    type: 'gap_fill',
    prompt: 'Ella nunca había viajado al extranjero; de ___ que se sintiera tan nerviosa en el aeropuerto.',
    expected_answer: 'ahí',
    answer_variants: null,
    hint_1: '"De ahí que" introduces a consequence and ALWAYS requires the subjunctive. Meaning: "hence / that is why". The connector is "de ahí que".',
    hint_2: 'Fill in the missing word so the connector reads "de ___ que". Unlike "por lo tanto" (indicative), "de ahí que" forces the subjunctive in the result clause.',
  },
  {
    concept_index: 8,
    type: 'transformation',
  ...
  // no obstante
  {
    concept_index: 9,
    type: 'gap_fill',
    prompt: 'El proyecto presentaba algunas deficiencias técnicas; ___, el comité decidió aprobarlo con condiciones.',
    expected_answer: 'no obstante',
    answer_variants: null,
    hint_1: 'Formal adversative connector meaning "nonetheless/notwithstanding". Follows a semicolon or full stop.',
    hint_2: 'Register distinction: "sin embargo" is formal; "no obstante" is even more formal, typical of written reports and official documents.',
  },
  {
    concept_index: 9,
    type: 'error_correction',
  ...
  // en cambio / por el contrario
  {
    ...
    answer_variants: null,
    hint_1: 'Blank 1: "on the other hand" — contrasts two people\'s different habits. Sits between commas.',
    hint_2: 'Blank 2: "on the contrary" — directly contradicts the preceding claim (it is not laziness). Sits before a semicolon.',
  },
  {
    concept_index: 10,
    type: 'translation',
  ...
  // mientras que
  {
    concept_index: 11,
    type: 'gap_fill',
    prompt: 'El norte de España tiene un clima lluvioso y verde, ___ el sur es árido y soleado casi todo el año.',
    expected_answer: 'mientras que',
    answer_variants: null,
    hint_1: '"Whereas/while" — expresses simultaneous contrast between two facts about different subjects in the same sentence.',
    hint_2: 'Unlike "sin embargo" or "no obstante" (which break the idea into two sentences), "mientras que" joins both contrasting ideas in one clause.',
  },
  {
    concept_index: 11,
    type: 'sentence_builder',
  ...
  // verbos de deseo
  {
    ...
    answer_variants: null,
    hint_1: '"Querer que" triggers the subjunctive: conjugate "venir" in the present subjunctive for "tú" (second person singular).',
    hint_2: '"Esperar que" also triggers the subjunctive: conjugate "llegar" in the present subjunctive for "todos" (third person plural).',
  },
  {
    concept_index: 12,
    type: 'transformation',
  ...
  // verbos de emoción
  {
    ...
    answer_variants: null,
    hint_1: '"Sorprender que" triggers the subjunctive: conjugate "saber" in the present subjunctive for "ella" (third person singular).',
    hint_2: '"Temer que" also triggers the subjunctive: conjugate "saber" in the present subjunctive for "los demás" (third person plural).',
  },
  {
    concept_index: 13,
    type: 'translation',
  ...
  // verbos de duda
  {
    ...
    answer_variants: null,
    hint_1: '"No creer que" triggers the subjunctive: conjugate "tener" in the present subjunctive for "Pedro" (third person singular).',
    hint_2: '"Dudar que" always requires the subjunctive: conjugate "estar" in the present subjunctive for "los demás" (third person plural).',
  },
  {
    concept_index: 14,
    type: 'error_correction',
  ...
  // conjunciones temporales
  {
    ...
    answer_variants: null,
    hint_1: '"Cuando" + future event = present subjunctive. Conjugate "llegar" in the present subjunctive for "tú".',
    hint_2: '"Hasta que" + future event = present subjunctive. Conjugate "recibir" in the present subjunctive for "yo".',
  },
  {
    concept_index: 15,
    type: 'transformation',
  ...
  // para que
  {
    ...
    answer_variants: null,
    hint_1: '"Para que" always takes the subjunctive. Conjugate "entender" in the present subjunctive for "tú".',
    hint_2: '"Para que" always takes the subjunctive. Conjugate "entender" in the present subjunctive for "todos" (third person plural).',
  },
  {
    concept_index: 16,
    type: 'translation',
  ...
  // condicional tipo 2
  {
    ...
    answer_variants: null,
    hint_1: '"Si" + imperfect subjunctive (hypothetical condition): conjugate "tener" in the imperfect subjunctive for "yo".',
    hint_2: 'Result clause of type 2 conditional = conditional tense. Conjugate "aprender" in the conditional for "yo".',
  },
  {
    concept_index: 17,
    type: 'translation',
  ...
  // condicional tipo 3
  {
    concept_index: 18,
    type: 'gap_fill',
    prompt: 'Si hubieras estudiado con más regularidad, ___ el examen sin ningún problema.',
    expected_answer: 'habrías aprobado',
    answer_variants: ['lo habrías aprobado'],
    hint_1: 'Type 3 conditional result clause = conditional perfect. Conjugate "aprobar" in the conditional perfect for "tú".',
    hint_2: 'Conditional perfect = habría/habrías/habría... + past participle. "Aprobar" past participle = aprobado.',
  },
  {
    concept_index: 18,
    type: 'transformation',
  ...
  // ojalá
  {
    concept_index: 19,
    type: 'gap_fill',
    prompt: 'Ojalá ___ más tiempo para disfrutar de la familia. Ojalá mis amigos también ___ visitarme con más frecuencia.',
    expected_answer: JSON.stringify(['tuviera', 'pudieran']),
    answer_variants: null,
    hint_1: '"Ojalá" + imperfect subjunctive = unlikely wish in the present. Conjugate "tener" in the imperfect subjunctive for "yo".',
    hint_2: '"Ojalá" + imperfect subjunctive. Conjugate "poder" in the imperfect subjunctive for "mis amigos" (third person plural).',
  },
  {
    concept_index: 19,
    type: 'translation',
  ...
  // estilo indirecto
  {
    ...
    answer_variants: null,
    hint_1: 'Sequence of tenses: the past main verb shifts "querer" (present) → imperfect indicative in reported speech. Fill in the imperfect of "querer".',
    hint_2: '"Esperar que" + present subjunctive in direct speech becomes + imperfect subjunctive in reported speech. "Llegar" imperfect subjunctive (ellos) = llegaran.',
  },
  {
    concept_index: 20,
    type: 'error_correction',
