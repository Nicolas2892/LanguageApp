...
export const SEED_EXERCISES: ExerciseSeed[] = [
  // aunque + indicativo
  {
    concept_index: 0,
    type: 'gap_fill',
    prompt: '________ está lloviendo a cántaros, saldremos a correr. (Use aunque + indicative)',
    expected_answer: 'Aunque',
    answer_variants: ['aunque'],
    hint_1: 'The connector meaning "even though" when presenting a fact.',
    hint_2: 'Starts with "A" and has 6 letters.',
  },
  {
    concept_index: 0,
    type: 'transformation',
  ...
  // aunque + subjuntivo
  {
    concept_index: 1,
    type: 'gap_fill',
    prompt: 'Aunque ________ (llover), la boda se celebrará al aire libre. (Complete with the correct form)',
    expected_answer: 'llueva',
    answer_variants: null,
    hint_1: 'The speaker is not certain if it will rain — it is a hypothetical concession.',
    hint_2: 'Present subjunctive of "llover": él/ella ________',
  },
  {
    concept_index: 1,
    type: 'translation',
  ...
  // a pesar de que
  {
    concept_index: 2,
    type: 'gap_fill',
    prompt: '________ de que hacía mucho frío, los niños jugaron en el parque.',
    expected_answer: 'A pesar',
    answer_variants: ['a pesar'],
    hint_1: 'A formal concessive connector meaning "despite" or "in spite of".',
    hint_2: 'Three words: A _____ de que.',
  },
  {
    concept_index: 2,
    type: 'transformation',
  ...
  // sin embargo
  {
    concept_index: 3,
    type: 'gap_fill',
    prompt: 'La película es muy larga; ________, me ha gustado mucho.',
    expected_answer: 'sin embargo',
    answer_variants: ['Sin embargo'],
    hint_1: 'A formal connector used after a semicolon to introduce a contrast.',
    hint_2: 'Translates as "however" or "nevertheless".',
  },
  {
    concept_index: 3,
  ...
  // por más que
  {
    concept_index: 4,
    type: 'gap_fill',
    prompt: '________ que lo intento, no consigo pronunciar la "r" española.',
    expected_answer: 'Por más',
    answer_variants: ['por más'],
    hint_1: '"No matter how much" = Por ___ que.',
    hint_2: null,
  },
  {
    concept_index: 4,
  ...
  // puesto que / ya que
  {
    concept_index: 5,
    type: 'gap_fill',
    prompt: '________ no tienes hambre, no hace falta que comas. (Use ya que)',
    expected_answer: 'Ya que',
    answer_variants: ['ya que'],
    hint_1: '"Since" or "given that" — the cause is already known.',
    hint_2: null,
  },
  {
    concept_index: 5,
  ...
  // dado que
  {
    concept_index: 6,
    type: 'gap_fill',
    prompt: '________ la situación es grave, debemos actuar de inmediato.',
    expected_answer: 'Dado que',
    answer_variants: ['dado que', 'En vista de que'],
    hint_1: '"Given that" — presents the cause as obvious or evident.',
    hint_2: null,
  },
  {
    concept_index: 6,
  ...
  // por lo tanto
  {
    concept_index: 7,
    type: 'gap_fill',
    prompt: 'El tren llegó tarde; ________, perdimos la conexión.',
    expected_answer: 'por lo tanto',
    answer_variants: ['por consiguiente', 'Por lo tanto', 'Por consiguiente'],
    hint_1: '"Therefore" or "consequently".',
    hint_2: null,
  },
  {
    concept_index: 7,
  ...
  // de ahí que
  {
    concept_index: 8,
    type: 'gap_fill',
    prompt: 'Es muy insegura, de ahí que no ________ (atreverse) a hablar en público.',
    expected_answer: 'se atreva',
    answer_variants: null,
    hint_1: '"De ahí que" always requires the subjunctive.',
    hint_2: '"Atreverse" in 3rd person present subjunctive = se ________.',
  },
  {
    concept_index: 8,
    type: 'transformation',
  ...
  // no obstante
  {
    concept_index: 9,
    type: 'gap_fill',
    prompt: 'El proyecto tiene muchos puntos positivos; ________, presenta algunas deficiencias.',
    expected_answer: 'no obstante',
    answer_variants: ['No obstante'],
    hint_1: 'A formal "nevertheless" or "however".',
    hint_2: null,
  },
  {
    concept_index: 9,
  ...
  // en cambio / por el contrario
  {
    concept_index: 10,
    type: 'gap_fill',
    prompt: 'A mí me encanta madrugar; mi pareja, ________, no se levanta antes de las diez.',
    expected_answer: 'en cambio',
    answer_variants: ['En cambio'],
    hint_1: '"On the other hand" — used to contrast two different situations.',
    hint_2: null,
  },
  {
    concept_index: 10,
  ...
  // mientras que
  {
    concept_index: 11,
    type: 'gap_fill',
    prompt: 'España es un país cálido, ________ los países escandinavos tienen un clima frío.',
    expected_answer: 'mientras que',
    answer_variants: null,
    hint_1: '"Whereas" — simultaneous contrast between two facts.',
    hint_2: null,
  },
  {
    concept_index: 11,
  ...
  // verbos de deseo
  {
    concept_index: 12,
    type: 'gap_fill',
    prompt: 'Quiero que tú ________ (venir) a cenar el sábado.',
    expected_answer: 'vengas',
    answer_variants: null,
    hint_1: '"Querer que" triggers the subjunctive when subjects differ.',
    hint_2: '"Venir" present subjunctive (tú) = ________.',
  },
  {
    concept_index: 12,
    type: 'transformation',
  ...
  // verbos de emoción
  {
    concept_index: 13,
    type: 'gap_fill',
    prompt: 'Me sorprende que ella no ________ (saber) la respuesta.',
    expected_answer: 'sepa',
    answer_variants: null,
    hint_1: '"Sorprender que" triggers subjunctive.',
    hint_2: '"Saber" present subjunctive (ella) = ________.',
  },
  {
    concept_index: 13,
    type: 'translation',
  ...
  // verbos de duda
  {
    concept_index: 14,
    type: 'gap_fill',
    prompt: 'No creo que Pedro ________ (tener) razón en este caso.',
    expected_answer: 'tenga',
    answer_variants: null,
    hint_1: '"No creer que" triggers the subjunctive.',
    hint_2: '"Tener" present subjunctive (él) = ________.',
  },
  {
    concept_index: 14,
    type: 'error_correction',
  ...
  // conjunciones temporales
  {
    concept_index: 15,
    type: 'gap_fill',
    prompt: 'Llámame cuando ________ (llegar) al aeropuerto.',
    expected_answer: 'llegues',
    answer_variants: null,
    hint_1: '"Cuando" + future action = subjunctive.',
    hint_2: '"Llegar" present subjunctive (tú) = ________.',
  },
  {
    concept_index: 15,
    type: 'transformation',
  ...
  // para que
  {
    concept_index: 16,
    type: 'gap_fill',
    prompt: 'Te lo repito para que lo ________ (entender) bien.',
    expected_answer: 'entiendas',
    answer_variants: null,
    hint_1: '"Para que" always requires the subjunctive.',
    hint_2: '"Entender" present subjunctive (tú) = ________.',
  },
  {
    concept_index: 16,
    type: 'translation',
  ...
  // condicional tipo 2
  {
    concept_index: 17,
    type: 'gap_fill',
    prompt: 'Si ________ (tener) más tiempo libre, aprendería a pintar.',
    expected_answer: 'tuviera',
    answer_variants: ['tuviese'],
    hint_1: 'Type 2 conditional: Si + imperfect subjunctive.',
    hint_2: '"Tener" imperfect subjunctive (yo) = ________.',
  },
  {
    concept_index: 17,
    type: 'translation',
  ...
  // condicional tipo 3
  {
    concept_index: 18,
    type: 'gap_fill',
    prompt: 'Si ________ (estudiar) más, habrías aprobado el examen.',
    expected_answer: 'hubieras estudiado',
    answer_variants: ['hubieses estudiado'],
    hint_1: 'Type 3: Si + pluperfect subjunctive (haber in imperfect subjunctive + past participle).',
    hint_2: '"Haber" imperfect subjunctive (tú) = hubieras / hubieses.',
  },
  {
    concept_index: 18,
    type: 'transformation',
  ...
  // ojalá
  {
    concept_index: 19,
    type: 'gap_fill',
    prompt: 'Ojalá ________ (poder) viajar más a menudo. (Unlikely wish in present)',
    expected_answer: 'pudiera',
    answer_variants: ['pudiese'],
    hint_1: 'Unlikely wish in present = Ojalá + imperfect subjunctive.',
    hint_2: '"Poder" imperfect subjunctive (yo) = ________.',
  },
  {
    concept_index: 19,
    type: 'translation',
  ...
  // estilo indirecto
  {
    concept_index: 20,
    type: 'transformation',
    prompt: 'Report in the past: María dice: "Quiero que vengas." → María dijo que...',
    expected_answer: 'María dijo que quería que fuera.',
    answer_variants: ['María dijo que quería que fuese.'],
    hint_1: 'Past reporting: present subjunctive → imperfect subjunctive.',
    hint_2: '"Venir" imperfect subjunctive (yo/él) = fuera / fuese.',
  },
  {
    concept_index: 20,
    type: 'error_correction',
