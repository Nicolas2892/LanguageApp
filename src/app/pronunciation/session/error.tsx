...
export default function PronunciationSessionError({
  error,
  reset,
}: {
      ...
      {offline ? (
        <>
          ...
          <p className="text-sm" style={{ color: 'var(--d5-warm)' }}>
            La sesión de pronunciación requiere conexión a internet.
          </p>
          <Link href={ROUTES.pronunciation} className="senda-cta-outline">Volver a Pronunciación</Link>
        </>
      ) : (
        <>
