...
export default function VocabConfigureError({
  error,
  reset,
}: {
      ...
      {isOffline ? (
        <>
          ...
          <p className="text-sm" style={{ color: 'var(--d5-warm)' }}>
            No se pudo cargar la configuración de vocabulario sin conexión.
          </p>
          <Link href={ROUTES.verbs} className="senda-cta-outline">Volver a Vocabulario</Link>
        </>
      ) : (
        <>
